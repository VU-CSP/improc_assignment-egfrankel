...
A1) 255 for an 8-bit image. The maximum intesnity of the file was 254 from the histogram.
...
***I uploaded the image into the image_files directory and named it as indicated but it wont show up here for some reason***

Q4) How many particles were detected?  
A4) 2306. I got this value based on the threshold I set, I had mine at 20 and 255 to try and isolate the cells from the background. 
